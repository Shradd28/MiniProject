...
<body bgcolor = "pink">
        <h1 align ='center'>Login for Regular batch</h1>
        <form method="post" action="login_regular.jsp">
            <center>
            <table border="1" width="30%" cellpadding="3">
                ...
                <tbody>
                    <tr>
                        <td>User Name</td>
                        <td><input type="text" name="username" value=""  required autocomplete="off"></td>
                    </tr>
                    <tr>
                        <td>Password</td>
        ...
        <br><br>
        <h1 align ='center'>Login for Exclusive batch</h1>
        <form method="post" action="login_exclusive.jsp">
            <center>
            <table border="1" width="30%" cellpadding="3">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2">Yet Not Registered!! <a href="exc.jsp">Register Here</a></td>
                    </tr>
                </tbody>
            </table>
            </center>
